...
export type VercelAiSdkTarget = "openai" | "openai-compatible";

export async function sendWithVercelAiSdk(
  input: LLMRequest,
...
function createSdkLanguageModel(input: LLMRequest, sdkTarget: VercelAiSdkTarget) {
